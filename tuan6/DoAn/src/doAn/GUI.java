...
public class GUI extends JFrame implements ActionListener {
	...
	private String[] arrOption = { "Email", "Số điện thoại               ","Nguồn ảnh" };
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o.equals(btnOption)) {
			...
			}else if(cboOption.getSelectedItem()=="Nguồn ảnh"){
				System.out.println("Danh sách nguồn ảnh của website là");
				try{
